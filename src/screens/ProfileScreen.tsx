    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs px-3.5 py-1.5 rounded-full bg-surface-container border border-outline-variant/40 text-secondary hover:border-primary transition"
        >
      ...
      {showFullView ? (
        ...
        <ScreenPlaceholder
          ...
          description="Personal Quran journey hub featuring reading statistics, Khatm history, milestone badges, saved bookmarks, and habit consistency graphs."
          stitchScreenName="Deenly User Profile"
          stitchScreenId="1227202f658c444388b7fee247f48c6a"
          stitchReady={true}
          currentRoute="/profile"
          featuresList={[
            'Personal habit analytics, total ayahs recited, and streak milestones',
            'Khatm history archive with completion certificates and timestamps',
            'Organized bookmark folder manager with personalized reflection tags',
            'Public vs Private spiritual milestone sharing options',
          ]}
        />
      )}
    </div>
