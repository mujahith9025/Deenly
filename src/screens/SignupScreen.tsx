...
import { BookOpen, ArrowRight, Lock, Mail, User, AlertCircle, Loader2 } from 'lucide-react'
...
export const SignupScreen: React.FC = () => {
  ...
  const { signUpWithEmail, signInWithGoogle, signInAsGuest, error, setError } = useAuth()
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 md:p-8 bg-background splash-gradient text-on-surface select-none relative">
      ...
      <div className="w-full max-w-md mx-auto p-6 md:p-8 rounded-3xl glass-card border border-outline-variant/40 shadow-2xl relative z-10">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold font-h1 text-primary-fixed-dim">Create Account</h1>
          <p className="text-xs text-on-surface-variant mt-1">
            Begin your daily Quran reading and habit journey
          </p>
        </div>
