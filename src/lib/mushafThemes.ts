...
export const MUSHAF_THEMES: Record<MushafThemeId, MushafThemeMeta> = {
  cosmic: {
    ...
    descEn: 'Cosmic dark glassmorphism with glowing purple accents.',
    descTa: 'ஒளிரும் ஊதா நிற டீன்லி கண்ணாடித் திரை.',
  ...
  oled: {
    ...
    descEn: 'Pure black mode for night reading and battery saving.',
    descTa: 'இரவு நேர வாசிப்பு மற்றும் பேட்டரி சேமிப்புக்கான தூய கருப்பு.',
  ...
  sepia: {
    ...
    descEn: 'Warm paper tones for zero eye strain during long reading.',
    descTa: 'கண் சோர்வை நீக்கும் மென்மையான காகித நிறம்.',
  ...
  emerald: {
    ...
    descEn: 'Madinah Mushaf-inspired rich emerald green and gold.',
    descTa: 'புனித மதீனா பாணியிலான மரகத பச்சை மற்றும் தங்கம்.',
  ...
  light: {
    ...
    descEn: 'Clean daylight mode with balanced contrast and clarity.',
    descTa: 'பகல் நேர வாசிப்புக்கான தெளிவான வெளிச்சத் திரை.',
