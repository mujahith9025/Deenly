...
export const MUSHAF_THEMES: Record<MushafThemeId, MushafThemeMeta> = {
  cosmic: {
    id: 'cosmic',
    nameEn: 'Cosmic Obsidian',
    nameTa: 'பிரபஞ்ச கருமை',
    descEn: 'Modern dark obsidian with deep violet cosmic glass accents.',
    descTa: 'வானியல் மற்றும் ஊதா கலந்த நவீன இருண்ட கண்ணாடித் திரை.',
    badgeEn: 'Default Modern',
    badgeTa: 'இயல்பு நவீன வடிவம்',
    icon: '🌌',
    previewColors: {
      bg: '#0c0a1a',
      card: '#16132f',
    ...
    classes: {
      container: 'bg-[#0c0a1a] text-white',
      card: 'bg-[#16132f]/90 backdrop-blur-xl border border-purple-500/30 shadow-2xl',
      cardBorder: 'border-purple-500/30',
      header: 'bg-[#120f26]/90 border-outline-variant/30 text-on-surface',
      footer: 'bg-[#120f26]/95 border-outline-variant/30 text-on-surface',
      textArabic: 'text-white',
      textTranslation: 'text-slate-300',
      textMuted: 'text-slate-400',
      accentPill: 'bg-primary/20 border-primary/40 text-primary-fixed-dim',
      buttonSecondary: 'bg-[#1e1a3d] border-outline-variant/40 text-slate-200 hover:border-primary',
