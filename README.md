...
- **Quran Catalog (`/quran`)**: High-contrast summary metrics (`114 Surahs • 6,236 Ayahs • 30 Juz`), modern Quran Surah cards with squircle numbers and calligraphy, clean action buttons (`▶ Play Surah` / `📖 Recite & Track`), and contextual translation toggle available inside specific chapter views.
