...
- **Explore Hub (`/explore`)**: Sleek **3-card balanced treasure grid** (`Tasbih & Dhikr`, `Hisnul Muslim (132 Duas)`, `99 Names of Allah`) with immediate direct-access layout, **Universal Target Setting** across all presets, real-time **Daily Progress** percentage calculation, and **Bilingual Hadith Virtues** (`English` | `தமிழ்` | `Dual`).
