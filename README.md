...
- **Settings Screen (`/settings`)**: Modular 10-category master-detail control center with concise descriptions, live visual previews, **dedicated Tajweed rule language toggle** (`English` ↔ `தமிழ்`) for Color Rules & Phonetic Guide, **top-positioned Playback Speed & Hifz Repeat Controls**, 13 Qari reciters with short single-line bios, and a comprehensive **About Deenly & Sources Showcase** detailing all 10 core built-in engines, 13 Qaris, 6 Hadith books, 8 scholarly source attribution cards, live Vercel link, and GitHub repository.
